...
# from .models import Student, Room, Complaint
...
# Home Page
# def home(request):
#     return HttpResponse("Welcome to AI Enabled Hostel Management System")


# AI Room Suggestion
# def suggest_room(request):

#     rooms = Room.objects.filter(occupied=False).first()

#     if rooms:
#         return render(request, 'hostel_app/suggest_room.html', {'room': rooms})
#     else:
#         return render(request, 'hostel_app/suggest_room.html', {'room': None})

# Add Student
# def suggest_room():
#     room = Room.objects.filter(occupied=False).first()
#     return room
...
# def rooms(request):
#     return render(request, 'hostel_app/rooms.html')
